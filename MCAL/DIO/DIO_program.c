...
uint8 DIO_u8TogglePinDirection(uint8 Copy_u8Port, uint8 Copy_u8Pin )//+
{
	...
	switch(Copy_u8Port)
	{
	case DIO_u8PORTA :	TOG_BIT(DDRA, Copy_u8Pin);		break;
	case DIO_u8PORTB :	TOG_BIT(DDRB, Copy_u8Pin);		break;
	case DIO_u8PORTC :	TOG_BIT(DDRC, Copy_u8Pin);		break;
	case DIO_u8PORTD :	TOG_BIT(DDRD, Copy_u8Pin);		break;
	default : Local_u8ErrorState = NOK;					break;
	}
